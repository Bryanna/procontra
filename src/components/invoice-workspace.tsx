      ...
      <form className="invoice-form" onSubmit={upload}>
        ...
        {isAuthorization && <>
          <div className="invoice-form-grid authorization-fields">
            ...
            <label><span>Cédula</span><input inputMode="numeric" name="governmentId" onChange={(event) => updateAuthorization("governmentId", event.target.value)} value={authorization.governmentId}/></label>
            ...
            <label><span>Teléfono</span><input inputMode="tel" name="phone" onChange={(event) => updateAuthorization("phone", event.target.value)} required value={authorization.phone}/></label>
